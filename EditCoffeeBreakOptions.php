...
<body>
    ...
    <nav class="navbar navbar-default">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav"> 
            ...
            <li><H1 class="NavEventPlanner"> Edit Coffee Break Options </H1></li> 
                ...
                <!-- This is repeated by the amount of category options there are --> 
                    ...
                    <div class="row" id="coffeeBreakOptions">
                                    <?php
                                            ...
                                            $sql = "SELECT `ID`, `Name`, `Price` FROM `categoryoptions` WHERE `IDMenuCategory` = 2"; // Coffee Break id = 2
                                            $result = mysqli_query($conn, $sql) or die(mysql_error());
    ...
    <div id="modalAddCategoryOption" class="modal">
        ...
        <div class="modal-content ">
            <div class="modal-header">
                ...
                <h2>Add New Coffee Break Option</h2>
            </div>
            ...
            <div class="modal-body ">
                ...
                <input type="button" class="button" value="Add" id="CreateCoffeeBreakOption">
            </div>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#CreateCoffeeBreakOption").click(function (){  
                //alert("entre"); 

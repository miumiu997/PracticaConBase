...
<body>
    ...
    <nav class="navbar navbar-default">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav"> 
            ...
            <li><H1 class="NavEventPlanner"> Edit Dinner Options </H1></li> 
        ...
        <div class="container">   
            <div class="row">
                <!-- This is repeated by the amount of category options there are --> 
                    ...
                    <div class="row" id="DinnerOptions">
                                    <?php

                                            $sql = "SELECT `ID`, `Name`, `Price` FROM `categoryoptions` WHERE `IDMenuCategory` = 4"; // Dinner id = 1
                                            $result = mysqli_query($conn, $sql) or die(mysql_error());
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-3">
                            <button id="DeleteDinnerOptionBtn" type="button" class="btn viewinfo2" data-toggle="modal" data-target="#myModal">Delete Dinner Option</button>
                        </div> 
                    </div> 
                    <div class="form-group row">
                        <label for="submit" class="col-md-1 col-form-label"></label> 
    ...
    <div id="modalAddCategoryOption" class="modal">
        ...
        <div class="modal-content ">
            ...
            <div class="modal-body ">
                ...
                <input type="button" class="button" value="Add" id="CreateDinnerOption">
            </div>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#DeleteDinnerOptionBtn").click(function (){  
               // alert("entre");
                $('#DinnerOptions :checked').each(function(){
                    //alert($(this).val()); 
                    $.ajax({
                        method: 'POST',
            ...
            $("#CreateDinnerOption").click(function (){  
                //alert("entre"); 

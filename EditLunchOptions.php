...
<body>
    ...
    <nav class="navbar navbar-default">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav"> 
            ...
            <li><H1 class="NavEventPlanner"> Edit Lunch Options </H1></li> 
                ...
                <!-- This is repeated by the amount of category options there are --> 
                    ...
                    <div class="row" id="LunchOptions"> 
                                    <?php
                                            ...
                                            $sql = "SELECT `ID`, `Name`, `Price` FROM `categoryoptions` WHERE `IDMenuCategory` = 3"; // Lunch id = 1
                                            $result = mysqli_query($conn, $sql) or die(mysql_error());
                    ...
                    <div class="form-group row">
                        <label for="submit" class="col-md-1 col-form-label"></label> 
                        <div class="col-md-3">
                            <button id="addMenuOptionBtn" type="button" class="btn viewinfo2" data-toggle="modal" data-target="#myModal">Add New Lunch Option</button>
                        </div> 
                    </div> 
    ...
    <div id="modalAddCategoryOption" class="modal">
        ...
        <div class="modal-content ">
            ...
            <div class="modal-body ">
                ...
                <input type="button" class="button" value="Add" id="CreateLunchOption">
            </div>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#CreateLunchOption").click(function (){  
                //alert("entre"); 

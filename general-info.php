...
<?php
    ...
    if (!array_key_exists('modify', $_SESSION)){
        $_SESSION['modify'] = 0;
    }
                ...
                <div class="row alignLeft">
                    <form id="form" name="form" method="post" action="EventRooms.php" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                                ...
                                <input class="form-control" type="text" name="first-name" id="first-name" 
                                       <?php 
                                            if ($_SESSION['modify']=="1" ) { 
                                                echo "value = '". $_SESSION['requestInfo']['Name'] . "'"; 
                                            } 
                                       ?> 
                                required>
                            </div>
                            ...
                            <div class="col-md-3">
                                <input class="form-control" type="text" id="last-name" name="last-name" required 
                                       <?php 
                                            if ($_SESSION['modify']=="1" ) { 
                                                echo "value = '". $_SESSION['requestInfo']['LastName'] . "'"; 
                                            } 
                                        ?> 
                                >
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <input class="form-control" type="email" name="email" id="email" required 
                                       <?php 
                                            if ($_SESSION['modify']=="1" ) { 
                                                echo "value = '". $_SESSION['requestInfo']['Email'] . "'"; 
                                            } 
                                       ?> 
                                >
                            </div>
                            ...
                            <div class="col-md-3">
                                <input class="form-control" min="0" type="number" id="telephone" name="telephone" required 
                                       <?php 
                                            if ($_SESSION['modify']=="1" ) { 
                                                echo "value = '". $_SESSION['requestInfo']['Cellphone'] . "'"; 
                                            } 
                                       ?> 
                                >
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <input class="form-control" type="date" name="start-date" id="start-date" required 
                                           <?php 
                                                if ($_SESSION['modify']=="1" ) { 
                                                    echo "value = '". $_SESSION['requestInfo']['StartDate'] . "'"; 
                                                } 
                                           ?> 
                                        >
                                </div>
                                ...
                                <div class="col-md-3">
                                    <input class="form-control" type="date" id="end-date" name="end-date" required 
                                           <?php 
                                                if ($_SESSION['modify']=="1" ) { 
                                                    echo "value = '". $_SESSION['requestInfo']['EndDate'] . "'";
                                                } 
                                           ?> 
                                    >
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <input class="form-control" type="text" name="company" id="company" required 
                                       <?php 
                                            if ($_SESSION['modify']=="1" ) { 
                                                echo "value = '". $_SESSION['requestInfo']['Company'] . "'"; 
                                            } 
                                       ?> 
                                >
                            </div>
                                ...
                                <select id="typeOfEvent" name="typeOfEvent">
                                    <?php
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                if ($_SESSION['modify'] == "1") {
                                                    if ($row['ID'] == $_SESSION['requestInfo']['TypeOfEvent']){
                                                        echo ' selected';   
                                                    }
                                                }
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <textarea id="reason" name="reason" rows="2" cols="29"><?php if ($_SESSION['modify'] == "1") { echo $_SESSION['requestInfo']['Reason'];}?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-1">
                                <input type="radio" name="publish" id="no" value="0"> No </input>
                            </div>
                        </div>

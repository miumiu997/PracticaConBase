                    ...
                    <form id="form" name="form" method="post" action="EventRooms.php" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                ...
                                <option value="3r">Dinner</option>
                                <option value="4">Exhibits</option>
                                <option value="5">Luncheon</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-1">
                                <input type="checkbox" name="publish" id="publish " value="1"> Yes </input>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <input class="form-control" type="text" value="" name="event-name" id="event-name" required>
                            </div>
        ...
        <script>
            $(document).ready(function () {
                $("#submit").click(function () {
                    ...
                    //alert("form");
                    /*
                    $.cookie("first-name", $("#first-name").val());
                    $.cookie("last-name", $("#last-name").val());
                    $.cookie("email", $("#email").val());
                    $.cookie("telephone", $("#telephone").val());
                    $.cookie("start-date", $("#start-date").val());
                    $.cookie("end-date", $("#end-date").val());
                    $.cookie("company", $("#company").val());
                    $.cookie("typeOfEvent", $("#typeOfEvent").val());
                    $.cookie("reason", $("#reason").val());
                    $.cookie("publish", $("#publish").val());
                    $.cookie("logo", $('#logo').files);
                    $.cookie("event-name", $("#event-name").val());
                    */
                    $("#form").submit();
